...
"Need to validate email format"
    ...
    ↑ Check: domain-web (validation requirements)
```
...
| PhantomData | Use unused type params / variance | `PhantomData<State>`, `PhantomData<&'a T>` |
...
| Option for "not yet initialized" fields | Unclear invariant | Builder (Option is fine for genuinely optional data) |

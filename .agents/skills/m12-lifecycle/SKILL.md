...
|----------|----------|-----|
| Connection pooling | domain-web | What's acceptable latency? |
| Resource limits | Project requirements | What are infra constraints? |
| Transaction scope | Project requirements | What must be atomic? |

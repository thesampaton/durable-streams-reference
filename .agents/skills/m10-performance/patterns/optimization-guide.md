...
// Note: in default repr(Rust), the compiler may reorder fields automatically.
// Manual ordering only matters with #[repr(C)].
// AVOID #[repr(packed)] — it creates unaligned fields, and references to
// unaligned fields are undefined behavior in Rust.
struct Good {
    b: u64,  // 8 bytes
    a: u8,   // 1 byte

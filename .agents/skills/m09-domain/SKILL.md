...
| Value Object | struct + Clone (Copy when all fields are Copy) | Shareable, immutable |
...
|-----------------|----------|-----|
| Entity vs Value Object | Project requirements | What makes two instances "the same"? |
| Aggregate boundaries | Project requirements | What must be consistent together? |
| Validation rules | domain-web | What business rules apply? |
...
impl Eq for User {}  // Identity equality is reflexive/transitive/symmetric
```

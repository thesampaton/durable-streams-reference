...
conformance: build $(CONFORMANCE_DIR)/node_modules
	...
	@DS_SERVER__LONG_POLL_TIMEOUT_SECS=2 cargo run $(CARGO_FEATURES) & SERVER_PID=$$!; \
...
benchmark-memory: release $(BENCHMARK_DIR)/node_modules
	@BENCHMARK_DIR=$(BENCHMARK_DIR) BENCHMARK_VITEST_FLAGS="$(BENCHMARK_VITEST_FLAGS)" \
		...
		env DS_SERVER__PORT=$(BENCHMARK_PORT) DS_LIMITS__MAX_MEMORY_BYTES=$(BENCHMARK_MAX_MEMORY_BYTES) DS_LIMITS__MAX_STREAM_BYTES=$(BENCHMARK_MAX_STREAM_BYTES) DS_STORAGE__MODE=memory cargo run --release $(CARGO_FEATURES)
...
benchmark-file: release $(BENCHMARK_DIR)/node_modules
	...
	@BENCHMARK_DIR=$(BENCHMARK_DIR) BENCHMARK_VITEST_FLAGS="$(BENCHMARK_VITEST_FLAGS)" \
		...
		env DS_SERVER__PORT=$(BENCHMARK_PORT) DS_LIMITS__MAX_MEMORY_BYTES=$(BENCHMARK_MAX_MEMORY_BYTES) DS_LIMITS__MAX_STREAM_BYTES=$(BENCHMARK_MAX_STREAM_BYTES) DS_STORAGE__MODE=file-durable DS_STORAGE__DATA_DIR=$(BENCHMARK_FILE_STORAGE_DIR) cargo run --release $(CARGO_FEATURES)
...
benchmark-acid: release $(BENCHMARK_DIR)/node_modules
	...
	@BENCHMARK_DIR=$(BENCHMARK_DIR) BENCHMARK_VITEST_FLAGS="$(BENCHMARK_VITEST_FLAGS)" \
		...
		env DS_SERVER__PORT=$(BENCHMARK_PORT) DS_LIMITS__MAX_MEMORY_BYTES=$(BENCHMARK_MAX_MEMORY_BYTES) DS_LIMITS__MAX_STREAM_BYTES=$(BENCHMARK_MAX_STREAM_BYTES) DS_STORAGE__MODE=acid DS_STORAGE__DATA_DIR=$(BENCHMARK_ACID_STORAGE_DIR) cargo run --release $(CARGO_FEATURES)
...
pgo-train-memory: $(BENCHMARK_DIR)/node_modules
	...
	@BENCHMARK_DIR=$(BENCHMARK_DIR) BENCHMARK_VITEST_FLAGS="$(BENCHMARK_VITEST_FLAGS)" \
		...
		env RUSTFLAGS="$(PGO_RUSTFLAGS_GEN)" DS_SERVER__PORT=$(BENCHMARK_PORT) DS_LIMITS__MAX_MEMORY_BYTES=$(BENCHMARK_MAX_MEMORY_BYTES) DS_LIMITS__MAX_STREAM_BYTES=$(BENCHMARK_MAX_STREAM_BYTES) DS_STORAGE__MODE=memory cargo run --release $(CARGO_FEATURES)
...
pgo-train-file: $(BENCHMARK_DIR)/node_modules
	...
	@BENCHMARK_DIR=$(BENCHMARK_DIR) BENCHMARK_VITEST_FLAGS="$(BENCHMARK_VITEST_FLAGS)" \
		...
		env RUSTFLAGS="$(PGO_RUSTFLAGS_GEN)" DS_SERVER__PORT=$(BENCHMARK_PORT) DS_LIMITS__MAX_MEMORY_BYTES=$(BENCHMARK_MAX_MEMORY_BYTES) DS_LIMITS__MAX_STREAM_BYTES=$(BENCHMARK_MAX_STREAM_BYTES) DS_STORAGE__MODE=file-durable DS_STORAGE__DATA_DIR=$(BENCHMARK_FILE_STORAGE_DIR) cargo run --release $(CARGO_FEATURES)
...
pgo-train-acid: $(BENCHMARK_DIR)/node_modules
	...
	@BENCHMARK_DIR=$(BENCHMARK_DIR) BENCHMARK_VITEST_FLAGS="$(BENCHMARK_VITEST_FLAGS)" \
		...
		env RUSTFLAGS="$(PGO_RUSTFLAGS_GEN)" DS_SERVER__PORT=$(BENCHMARK_PORT) DS_LIMITS__MAX_MEMORY_BYTES=$(BENCHMARK_MAX_MEMORY_BYTES) DS_LIMITS__MAX_STREAM_BYTES=$(BENCHMARK_MAX_STREAM_BYTES) DS_STORAGE__MODE=acid DS_STORAGE__DATA_DIR=$(BENCHMARK_ACID_STORAGE_DIR) cargo run --release $(CARGO_FEATURES)
...
pgo-benchmark-memory: pgo-build $(BENCHMARK_DIR)/node_modules
	@BENCHMARK_DIR=$(BENCHMARK_DIR) BENCHMARK_VITEST_FLAGS="$(BENCHMARK_VITEST_FLAGS)" \
		...
		env RUSTFLAGS="$(PGO_RUSTFLAGS_USE)" DS_SERVER__PORT=$(BENCHMARK_PORT) DS_LIMITS__MAX_MEMORY_BYTES=$(BENCHMARK_MAX_MEMORY_BYTES) DS_LIMITS__MAX_STREAM_BYTES=$(BENCHMARK_MAX_STREAM_BYTES) DS_STORAGE__MODE=memory cargo run --release $(CARGO_FEATURES)
...
pgo-benchmark-file: pgo-build $(BENCHMARK_DIR)/node_modules
	...
	@BENCHMARK_DIR=$(BENCHMARK_DIR) BENCHMARK_VITEST_FLAGS="$(BENCHMARK_VITEST_FLAGS)" \
		...
		env RUSTFLAGS="$(PGO_RUSTFLAGS_USE)" DS_SERVER__PORT=$(BENCHMARK_PORT) DS_LIMITS__MAX_MEMORY_BYTES=$(BENCHMARK_MAX_MEMORY_BYTES) DS_LIMITS__MAX_STREAM_BYTES=$(BENCHMARK_MAX_STREAM_BYTES) DS_STORAGE__MODE=file-durable DS_STORAGE__DATA_DIR=$(BENCHMARK_FILE_STORAGE_DIR) cargo run --release $(CARGO_FEATURES)
...
pgo-benchmark-acid: pgo-build $(BENCHMARK_DIR)/node_modules
	...
	@BENCHMARK_DIR=$(BENCHMARK_DIR) BENCHMARK_VITEST_FLAGS="$(BENCHMARK_VITEST_FLAGS)" \
		...
		env RUSTFLAGS="$(PGO_RUSTFLAGS_USE)" DS_SERVER__PORT=$(BENCHMARK_PORT) DS_LIMITS__MAX_MEMORY_BYTES=$(BENCHMARK_MAX_MEMORY_BYTES) DS_LIMITS__MAX_STREAM_BYTES=$(BENCHMARK_MAX_STREAM_BYTES) DS_STORAGE__MODE=acid DS_STORAGE__DATA_DIR=$(BENCHMARK_ACID_STORAGE_DIR) cargo run --release $(CARGO_FEATURES)
